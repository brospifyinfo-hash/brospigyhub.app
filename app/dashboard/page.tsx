  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
        <section className="mesh-hero interactive-card rounded-3xl border border-[var(--glass-border)] p-6 shadow-2xl sm:p-8 lg:col-span-8">
        ...
        <section className="surface-card interactive-card rounded-3xl p-6 lg:col-span-4">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[var(--color-text-muted)]">
            Live-Statistiken
          </p>
          <div className="mt-5 grid grid-cols-2 gap-3">
            <div className="rounded-2xl border border-[var(--glass-border)] bg-white/5 p-4">
              <NewMessagesStat
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
        <section className="surface-card interactive-card rounded-3xl p-6 lg:col-span-7">
            ...
            {!user ? (
              ...
              <>
                {recentMessages.map((msg) => (
                  ...
                  className="interactive-card flex items-center justify-between rounded-2xl border border-[var(--glass-border)] bg-white/5 px-4 py-3 transition-colors duration-300 ease-out hover:bg-white/10"
                  >
                    <div>
        ...
        <section className="surface-card interactive-card rounded-3xl p-6 lg:col-span-5">
          ...
          <div className="mt-4 space-y-3">
            {notificationCard && (
              <Link
                ...
                className="interactive-card block rounded-2xl border border-blue-400/45 bg-blue-500/10 p-4 shadow-sm transition-colors duration-300 ease-out hover:bg-blue-500/20"
              >
            ...
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
              {otherChannelCards.map((ch) => (
                <Link
                  ...
                  className="interactive-card rounded-2xl border border-[var(--glass-border)] bg-white/5 p-3 transition-colors duration-300 ease-out hover:bg-[var(--color-accent-muted)]"
                >
